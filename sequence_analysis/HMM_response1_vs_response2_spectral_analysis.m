...
%% Within state 
% This is NOT a Response 1 vs Response 2 test
% This test does not take place on a subject level because 
% a) That would be wrong since our entire pipeline is based on single trial
% differences
% b) The advantage is that we get a large number of trials across which we
% can reliably run a permutation test
dataset_path = 'Q:\tactstim_resting\code\tactstim_rest_data\';
model_path = 'Q:\tactstim_resting\code\tactstim_rest_models\';
model_name = '_04_Feb_2022_17_04_27_HMM_model_preStim_rest_250Hz.mat';
single_trial_hmm = 'Q:\tactstim_resting\code\tactstim_rest_data\subject_trial_specific_hmms\';
